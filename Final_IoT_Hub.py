...
MSG_TXT = "{\"deviceId\": \"MOHITA'S PI,\"temperature\": %f,\"Light\": %f,\"Button1Status\": %r,\"Button2Status\" %r}"
    ...
    try:
        ...
        while True:
            ...
            if MESSAGE_SWITCH:
                ...
                but1_stat=sensor.is_sw_dio22_pressed()
                but2_stat=sensor.is_sw_dio18_pressed()
                msg_txt_formatted = MSG_TXT % (
                    temperature,
                    light,but1_stat,but2_stat)
